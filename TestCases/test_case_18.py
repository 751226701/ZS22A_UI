...
from Pages.SystemPage.SystemPage6 import SystemPage
from Common.ReadYaml import ReadYaml
from Common.AllurePretty import PrettyAllure
from Config.Config import Config

yaml_data = ReadYaml(os.path.join(Config.test_datas_dir, "test_data_18.yaml")).read()
logindata = yaml_data[0]
Trace = Config.trace18
pageobject = None
DOWNLOAD_FLAG = False
...
def login(pageobject, url, user, passwd):
    ...
    pageobject.get_by_role("menuitem", name="屏蔽区域").click()
